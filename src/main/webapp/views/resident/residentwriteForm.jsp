...
<title>Insert title here</title>
	...
	<script>
		$(document).ready(function() {
			...
			//문의사항 답변 수정 유효성 검사
			$('#residentwriteFormBtn').click(function()
			{
				if($('#re_name').val() == '')
				{
					alert('이름을 입력하세요');
				...
				}else if($('#re_text').val() == '')
				{
					...
					$('#re_text').focus();
					return;
				}else if($('#photo_fp_oriFileName').val() == '')
				{
					alert('입소자 사진을 등록하세요');
					$('#photo_fp_oriFileName').focus();
					return;
				}else if($('#fp_oriFileName').val() == '')
				{
					alert('파일을 등록하세요');
					$('#fp_oriFileName').focus();
					return;
				}

				$('#residentwriteForm').submit();
			});
				//취소 버튼 클릭시 이전페이지로			
...
<div class="page-content">
         ...
         <form action="residentwrite.do" method="POST" enctype="multipart/form-data" class="form form-horizontal" id="residentwriteForm">
               <div class="d-flex align-items-center">
		               ...
		               <div class="input-group mb-3">
		                ...
		                <div class="input-group mb-3">
		                   ...
		                   <input type="file"  class="form-control" aria-label="Username" 
											aria-describedby="basic-addon1"  name="photo_fp_oriFileName" placeholder="사진" value="${rd.photo_fp_oriFileName}" id="photo_fp_oriFileName" autofocus>
		               </div>
						<div class="input-group mb-3">
                   ...
                   <div class="col-sm-12 d-flex justify-content-end">
                         ...
                         <button type="button" id="residentwriteFormBtn" class="btn btn-primary">등록</button>
