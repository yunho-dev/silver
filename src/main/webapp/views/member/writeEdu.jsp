...
<body>
	<!--large size Modal -->
	<div class="modal fade text-left" id="writeEdu" tabindex="-1" role="dialog"
	            ...
	            <form id="memberEduWriteForm">
		            ...
		            <div class="modal-footer" >
		            	<div style="margin: auto;">
		            		<button type="button" class="btn btn-primary ml-1" id="mypageEduRegist">
...
//학력 등록 유효성 검사
$("#mypageEduRegist").click(function(){
	var $memId = $('#memberEduWriteForm input[name=memId]');
	/* Left */
	var $eduName = $('#memberEduWriteForm input[name=eduName]');
	var $eduPass = $('#memberEduWriteForm input[name=eduPass]');
	var $eduSuccess = $('#memberEduWriteForm select[name=eduSuccess]');

	/* Right */
	var $eduStart = $('#memberEduWriteForm input[name=eduStart]');
	var $eduEnd = $('#memberEduWriteForm input[name=eduEnd]');
	...
	var formData = new FormData(); // 파일 + 텍스트 전송을 위한 FormData 객체
		...
		if($eduName.val()==''){
			...
			$('#memberEduWriteForm input').each(function(){
