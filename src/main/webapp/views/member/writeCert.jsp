...
<body>
	<!--large size Modal -->
	<div class="modal fade text-left" id="writeCert" tabindex="-1" role="dialog"
	    aria-labelledby="myModalLabel17" aria-hidden="true">
	    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-lg"
	        role="document">
	        <div class="modal-content">
	            <div class="modal-header">
	                <h4 class="modal-title" id="myModalLabel17">자격증 등록</h4>
	                <button type="button" class="close" data-bs-dismiss="modal"
	                    aria-label="Close" style="font-size: 22pt;">
	                    &times;
	                </button>
	            </div>
	            <form id="memberCertWriteForm">
		            ...
		            <div class="modal-footer" >
		            	<div style="margin: auto;">
		            		<button type="button" class="btn btn-primary ml-1" id="mypageCertRegist">
...
//자격증 등록 유효성 검사
$("#mypageCertRegist").click(function(){
	var $memId = $('#memberCertWriteForm input[name=memId]');
	/* Left */
	var $certName = $('#memberCertWriteForm input[name=certName]');
	var $certPlace = $('#memberCertWriteForm input[name=certPlace]');

	/* Right */
	var $certDate = $('#memberCertWriteForm input[name=certDate]');
	...
	var formData = new FormData(); // 파일 + 텍스트 전송을 위한 FormData 객체
		...
		if($certName.val()==''){
			...
			$('#memberCertWriteForm input').each(function(){
