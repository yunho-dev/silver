...
<body>
	<!--large size Modal -->
	<div class="modal fade text-left" id="writeFileInsert" tabindex="-1" role="dialog"
	    aria-labelledby="myModalLabel17" aria-hidden="true">
	    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-lg"
	        role="document">
	        <div class="modal-content">
	            <div class="modal-header">
	                <h4 class="modal-title" id="myModalLabel17">서류파일 등록</h4>
	                <button type="button" class="close" data-bs-dismiss="modal"
	                    aria-label="Close" style="font-size: 22pt;">
	                    &times;
	                </button>
	            </div>
	            <form id="memberwriteFileInsertForm">
		            <div class="modal-body">
						<div class="writeLeft">
						<p id="memId" style="display: none;"></p> 
						<input type="hidden" name='memId' value="${info.mem_id}">
<!-- 						<input type="hidden" name="FpcIdx">	 -->				
							<p class="writeArea">
		            ...
		            <div class="modal-footer" >
		            	<div style="margin: auto;">
		            		<button type="button" class="btn btn-primary ml-1" id="memDocumentFileInsert">
...
// 서류파일  등록 유효성 검사
$("#memDocumentFileInsert").click(function(){
	
	var $memId = $('#memberwriteFileInsertForm input[name=memId]');

	var $fpcCate = $('#memberwriteFileInsertForm select[name=fpcCate]');
	...
	if($fpcCate.val()==''){
		...
		$fpcCate.focus();
			...
			$('#memberwriteFileInsertForm input').each(function(){
