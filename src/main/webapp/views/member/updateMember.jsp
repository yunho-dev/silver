...
<body>
	<!--large size Modal -->
	<div class="modal fade text-left" id="updateMember" tabindex="-1" role="dialog"
	            ...
	            <form id="memberUpdateForm">
		            ...
		            <div class="modal-footer" >
		            	<div style="margin: auto;">
		            		<button type="button" class="btn btn-primary ml-1" id="memUpdateRegist">
...
// 직원 등록 유효성 검사
$("#memUpdateRegist").click(function(){
	
	/* Left */
	var $memName = $('#memberUpdateForm input[name=memName]');
	var $memId = $('#memberUpdateForm input[name=memId]');
	var $departName = $('#memberUpdateForm select[name=departName]');
	var $memIndate = $('#memberUpdateForm input[name=memIndate]');
	var $memBirth = $('#memberUpdateForm input[name=memBirth]');
	var $memAddr = $('#memberUpdateForm input[name=memAddr]');
	/* Right */
	var $posName = $('#memberUpdateForm select[name=posName]');
	var $memPw = $('#memberUpdateForm input[name=memPw]');
	var $partName = $('#memberUpdateForm select[name=partName]');
	var $memPnum = $('#memberUpdateForm input[name=memPnum]');
	var $memGender = $('#memberUpdateForm input[name=memGender]');
	var $memDaddr = $('#memberUpdateForm input[name=memDaddr]');	
	var $memEmail = $('#memberUpdateForm input[name=memEmail]');
	var $memState = $('#memberUpdateForm select[name=memState]');
	/* 날짜 정규식 */
		...
		if($memName.val()==''){
			...
			$('#memberUpdateForm input').each(function(){
				...
				if(key == 'memPhoto'){
					...
					formData.append(key5, $memState.val());
				}
			})
